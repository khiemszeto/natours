...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2hpZW1raGFuaCIsImEiOiJjbWt3OGY1bzcwZXl2M2RzbHc2amtjMjR0In0.rwh97JaKzVu-Q2mbZ-2Zkg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/khiemkhanh/cmkw8sitb007k01sb2bc8ddw5',
    // style URL
    scrollZoom: false
  });
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alerts.showAlert)('error', (_error$response = _t.response) === null || _error$response === void 0 ? void 0 : _error$response.data.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(email, password) {
    var result, _error$response2, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlert)('error', (_error$response2 = _t2.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.data.message);
        case 3:
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, result, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
